...
public class ReportWorkerVerticle extends AbstractVerticle {
    ...
    private static final java.time.format.DateTimeFormatter DATE_FORMATTER = java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
    ...
    private byte[] generateSimplePdf(List<JsonObject> ipList, String subnetLabel) throws Exception {
        ...
        content.append("(Generated: ").append(java.time.LocalDateTime.now().format(DATE_FORMATTER)).append(") Tj\n");
